...
test( "Find numeric minimum values", 7, function (){
  ...
  equal ( findMinValue([3, 5, 7, 20, .18, 01, -1.1, 12, Infinity, Infinity, 0.18, -1.1, 12]), -1.1, "Expected the min vlue of [3, 5, 7, 20, .18, 01, -1.1, 12, Infinity, Infinity, 0.18, -1.1, 12] to be 01.1");
});
