...
test( "reverseString", 3, function() {
    ...
    // Make sure the result from the divide function is valid
    // ok( divide( 4, 2 ), 2, 'Expected 2 as the result, the result was: ' + divide( 4, 2 ) );
    ok( reverseString( "abcd" ), "dcba", 'Expected siht as the result, the result was: ' + reverseString( "abcd" ) );
    ok( reverseString( "As" ), " ", 'Expected sA as the result, the result was: ' + reverseString( "As" ) );
});
