...
Unit Test Example
********************************/
 module( "Example Unit Test" );   module( "Example Unit Test" );
 test( "Example Test", 2, function() {   test( "Example Test", 2, function() {
     // Verify the method exists       // Verify the method exists
     equal( typeof divide, 'function', 'Must contain a divide function' );        equal( typeof divide, 'function', 'Must contain a divide function' ); 
    
     // Make sure the result from the divide function is valid       // Make sure the result from the divide function is valid
    ok( divide( 4, 2 ), 2, 'Expected 2 as the result, the result was: ' + divide( 4, 2 ) );  + // >>>>> this example was wrong.  I changed below - "divide(4,2), 2,"  to "divide(4,2) == 2," 
...
test('split String using comma', 3, function() {
    ...
    var SourceStr = 'Karunakar,Reddy';
    var resultStr = splitListStrUsingComma(sourceStr);
	ok( resultStr[0] =='Karunakar'&& resultStr[1]=='Reddy', 
    'Expected true as the result, the result was false');
