     ...
     $("#foobar").append("<input type='checkbox' name='A'/> <input type='checkbox' name='B'/> <a id='CheckAll' href='#'>Check All</a> <a href='#' id='UnCheckAll'>UnCheck All</a>");
